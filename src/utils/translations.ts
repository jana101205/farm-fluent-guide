export const translations = {
  en: {
    ...
    choosePicture: "Choose from Gallery",
    ...
    feedbackDesc: "Share your suggestions and report issues"
  },
  hi: {
    greeting: "सुप्रभात",
    ...
    choosePicture: "गैलरी से चुनें",
    uploadImage: "छवि अपलोड करें",
    analyzing: "विश्लेषण कर रहे हैं...",
    processing: "आपकी छवि संसाधित कर रहे हैं...",
    results: "परिणाम",
    recommendations: "सिफारिशें",
    submitFeedback: "फीडबैक जमा करें",
    feedbackTitle: "हमें बेहतर बनाने में मदद करें",
    feedbackDesc: "अपने सुझाव साझा करें और समस्याओं की रिपोर्ट करें"
  },
  ta: {
    ...
    features: {
      ...
      feedback: { title: "கருத்து", description: "உங்கள் அனுபவத்தை பகிருங்கள்" },
    },
    plantCare: "தாவர பராமரிப்பு",
    myPlants: "என் தாவரங்கள்",
    cropCalendar: "பயிர் நாட்காட்டி",
    fertilizerCalc: "உர கணக்கீடு",
    irrigation: "நீர்ப்பாசன திட்டமிடல்",
    diseaseLibrary: "நோய் நூலகம்",
    selectLanguage: "மொழியை தேர்வு செய்க",
    choosePreferred: "உங்கள் விருப்ப மொழியை தேர்வு செய்யுங்கள்",
    takePicture: "புகைப்படம் எடுக்கவும்",
    choosePicture: "காட்சியகத்திலிருந்து தேர்வு செய்யவும்",
    uploadImage: "படம் பதிவேற்றவும்",
    analyzing: "பகுப்பாய்வு செய்கிறோம்...",
    processing: "உங்கள் படத்தை செயலாக்குகிறோம்...",
    results: "முடிவுகள்",
    recommendations: "பரிந்துரைகள்",
    submitFeedback: "கருத்து சமர்பிக்கவும்",
    feedbackTitle: "எங்களை மேம்படுத்த உதவுங்கள்",
    feedbackDesc: "உங்கள் பரிந்துரைகளை பகிருங்கள் மற்றும் சிக்கல்களை தெரிவிக்கவும்"
  },
  te: {
    greeting: "శుభోదయం",
    ...
    plantCare: "మొక్కల సంరక్షణ",
    myPlants: "నా మొక్కలు",
    cropCalendar: "పంట క్యాలెండర్",
    fertilizerCalc: "ఎరువుల కాలిక్యులేటర్",
    irrigation: "నీటిపారుదల ప్రణాళిక",
    diseaseLibrary: "వ్యాధుల గ్రంథాలయం",
    selectLanguage: "భాష ఎంచుకోండి",
    choosePreferred: "మీ ఇష్టమైన భాష ఎంచుకోండి",
    takePicture: "ఫోటో తీయండి",
    choosePicture: "గ్యాలరీ నుండి ఎంచుకోండి",
    uploadImage: "చిత్రం అప్‌లోడ్ చేయండి",
    analyzing: "విశ్లేషిస్తున్నాము...",
    processing: "మీ చిత్రాన్ని ప్రాసెస్ చేస్తున్నాము...",
    results: "ఫలితాలు",
    recommendations: "సిఫార్సులు",
    submitFeedback: "అభిప్రాయం సమర్పించండి",
    feedbackTitle: "మాకు మెరుగుపరచడంలో సహాయపడండి",
    feedbackDesc: "మీ సూచనలను పంచుకోండి మరియు సమస్యలను నివేదించండి"
  },
  pa: {
    ...
    fertilizerCalc: "ਖਾਦ ਗਿਣਤੀ",
    irrigation: "ਸਿੰਚਾਈ ਯੋਜਨਾ",
    diseaseLibrary: "ਰੋਗ ਲਾਇਬ੍ਰੇਰੀ",
    selectLanguage: "ਭਾਸ਼ਾ ਚੁਣੋ",
    choosePreferred: "ਆਪਣੀ ਪਸੰਦੀਦਾ ਭਾਸ਼ਾ ਚੁਣੋ",
    takePicture: "ਫੋਟੋ ਲਓ",
    choosePicture: "ਗੈਲਰੀ ਤੋਂ ਚੁਣੋ",
    uploadImage: "ਚਿੱਤਰ ਅੱਪਲੋਡ ਕਰੋ",
    analyzing: "ਵਿਸ਼ਲੇਸ਼ਣ ਕਰ ਰਹੇ ਹਾਂ...",
    processing: "ਤੁਹਾਡੀ ਤਸਵੀਰ ਦਾ ਪ੍ਰਾਸੈਸਿੰਗ ਕਰ ਰਹੇ ਹਾਂ...",
    results: "ਨਤੀਜੇ",
    recommendations: "ਸਿਫਾਰਸ਼ਾਂ",
    submitFeedback: "ਫੀਡਬੈਕ ਦਿਓ",
    feedbackTitle: "ਸਾਨੂੰ ਬਿਹਤਰ ਬਣਾਉਣ ਵਿੱਚ ਮਦਦ ਕਰੋ",
    feedbackDesc: "ਆਪਣੇ ਸੁਝਾਅ ਸਾਂਝੇ ਕਰੋ ਅਤੇ ਸਮੱਸਿਆਵਾਂ ਦੀ ਰਿਪੋਰਟ ਕਰੋ"
  }
};